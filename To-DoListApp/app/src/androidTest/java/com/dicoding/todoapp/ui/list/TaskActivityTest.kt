...
class TaskActivityTest {
    ...
    @get:Rule
    var ruleActivity = ActivityScenarioRule(TaskActivity::class.java)
    ...
    fun test() {
        ...
        val newTask = getNewTaskActivity()
        assertTrue(newTask?.javaClass == AddTaskActivity::class.java)
    ...
    private fun getNewTaskActivity(): Activity? {
